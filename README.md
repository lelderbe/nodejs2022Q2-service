...
After starting the app on port (4000 as default) you can open test it in your browser OpenAPI documentation by typing http://localhost:4000/doc/ (autogenerated API documentation).
